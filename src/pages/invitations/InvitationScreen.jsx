...
const InvitationScreen = () => {
  return (
    <div>
      <Header />
      <div className="invitationImage"></div>
      <div className="invitationContainer">
        <div>
          ...
          >
            ...
            eiusm od tempor incidi dunt ut labore et dolore magna aliqua ut enim
          ...
          >
            Please, be here on time. Wedding starts at 4pm, celebration dinner
            starts at 5pm.
          </div>
        </div>
      </div>
