          ...
          <div className="mapContainer">
            <div className="locationDetails">
              ...
              <div style={locationDetails}>
                ...
                <div className="locationDetailsText">
                  Vineyard at Pier 26, Hudson river park, New York
                </div>
              </div>
              <div style={locationDetails}>
                <div>
              ...
              <div style={locationDetails}>
                <div>
                  <FeatherIcon icon="instagram" size="15" />
                </div>
            ...
            <div className="locationMap">
              <img
                src="https://images.unsplash.com/photo-1586449480558-33ae22ffc60d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Nnx8Z29vZ2xlJTIwbWFwfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60"
                alt=""
                style={locationMapImage}
              />
            </div>
          </div>
        </div>
